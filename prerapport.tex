...
\section{Les algorithmes utilisés}
	\subsection{Algorithmes témoins}
		Algorithmes naïfs servant de point de comparaison : 
			\begin{itemize}
				\item{Estimer un rating inconnu par la moyenne de tous les ratings connus}
				\item{Estimer la note donnée par un utilisateur à un objet par la moyenne des notes données par les autres utilisateurs à cet objet}
