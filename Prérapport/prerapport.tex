...
\section{Les algorithmes utilisés}
	...
	\subsection{Analyse en composantes principales : algorithme Eigentaste}
		...
		On commence par normaliser les ratings des utilisateurs sur les objets du gauge set : la qualité objective d'un objet importe peu ici car on cherche à obtenir des informations sur les ressemblances entre utilisateurs.
		...
		On obtient alors la matrice $A$ des ratings normalisés sur le gauge set : $a_{ij} = \frac{r_{ij}-\mu_j}{\sigma_j}$.
